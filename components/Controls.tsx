...
export type ScreenShareQuality = 'auto' | '720p30' | '1080p30' | '1080p60';
...
export default function Controls({
  ...
  return (
    <div className="flex items-center justify-center gap-2 sm:gap-3 flex-wrap px-3">
      ...
      <label className="flex h-12 items-center gap-2 rounded-full border border-surface-border bg-surface-card px-3 text-xs text-white/75">
        ...
        <select
          ...
          className="max-w-[112px] bg-transparent text-xs text-white outline-none"
        >
