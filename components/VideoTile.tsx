...
function Avatar({ name }: { name: string }) {
  ...
  return (
    <div className="h-16 w-16 sm:h-20 sm:w-20 rounded-full bg-gradient-to-br from-brand-400 via-brand-600 to-brand-800 flex items-center justify-center text-xl sm:text-2xl font-semibold text-white">
      {initial}
    </div>
  );
}
