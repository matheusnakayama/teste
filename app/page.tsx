          ...
          <section>
            ...
            <div className="mt-9 flex flex-col sm:flex-row gap-3 max-w-md">
              <button
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-br from-brand-500 via-brand-600 to-brand-800 hover:brightness-110 active:brightness-95 transition px-5 py-3.5 font-semibold text-white shadow-lg shadow-brand-900/40"
              >
                <PlusIcon />
                Criar sala
              </button>
...
function LogoMark() {
  return (
    <div className="h-9 w-9 rounded-lg bg-gradient-to-br from-brand-400 via-brand-600 to-brand-800 flex items-center justify-center">
